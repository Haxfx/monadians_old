...
.tab-buttons {
  ...
  z-index: 99999; /* Set a higher z-index for the tab buttons */
...
.tab-button:hover {
  ...
  min-height: 901px;
  padding-top: 110px;
  background-color: #1c0638; /* Your color code */
  background-image: linear-gradient(to bottom, rgba(28, 6, 56, 0) 10%, rgba(28, 6, 56, 1) 10%);
...
`;
export const AboutStyleWrapperMobile = styled.section`
.tab-buttons {
  display: flex;
  gap: 10px; /* Adjust the space between buttons as needed */
  z-index: 99999; /* Set a higher z-index for the tab buttons */
